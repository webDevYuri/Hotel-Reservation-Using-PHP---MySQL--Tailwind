<div class="facilities flex items-center justify-center relative px-20">
    <div class="tagline-wrapper flex items-center bg-green-50 justify-center rounded-lg px-5 py-20" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px; background-color: rgba(255, 255, 255, 0.5); backdrop-filter: blur(10px)">
        ...
        <div class="tagline-container flex-col px-10 text-center">
            <h1 class="text-7xl font-bold z-10 text-green-950" style="text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5)">Our Facilities</h1>
            <p style="max-width: 800px;" class="mt-5 text-lg text-green-900 z-10">Indulge in our thoughtfully designed accommodations that promise an enriching stay. Located in the heart of Cabanatuan City, our inviting facilitiess combine modern comforts with the warmth of contemporary Filipino elegance, ensuring a truly memorable experience.</p>
        </div>
...
<div class="deluxe-room items-center flex">
    ...
    <img src="assets/facilities/facilityFive.jpg" alt="FACILITY FOUR" class="w-1/2">
</div>
