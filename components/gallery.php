<div class="gallery flex items-center justify-center">
    ...
    <div class="tagline-container flex-col px-10 text-center">
        <h1 class="text-7xl font-bold z-10 text-green-950" style="text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5)">Treasured Times</h1>
        <p style="max-width: 800px;" class="mt-5 text-lg text-green-900 z-10">Create picture-perfect memories at Grand Luxe Hotel. Share your unforgettable experiences with us, and don’t forget to tag us in your posts!</p>
        <a href="#" class="text-2xl font-semibold mt-3 underline text-green-950">@dianashotel@gmail.com</a>
        <div class="mt-4 flex gap-4 justify-center">
            <a href="#"><i class="fa-brands fa-facebook text-4xl text-green-950"></i></a>
            <a href="#"><i class="fa-brands fa-tiktok text-4xl text-green-950"></i></a>
            <a href="#"><i class="fa-brands fa-square-instagram text-4xl text-green-950"></i></a>
        </div>
    </div>
