        ...
        <nav class="navbar py-2 fixed top-0 left-0 w-full z-50">
            ...
            <div class="p-10 nav-link-list">
                <ul class="nav-container flex items-center gap-7 justify-center">
                    ...
                    <li>
                        <a href="offers-page.php" class="nav-link link-active duration-300 ease-in text-xl font-semibold text-green-50 bg-green-950 rounded-br-3xl rounded-tl-3xl px-5 py-2" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">OFFERS</a>
                    </li>
                    <li>
